...
public class Add_Update_User extends Activity {
	...
	if (called_from.equalsIgnoreCase("add")) {
		...
		DateFormat df=new SimpleDateFormat("EEE,d MMM yyy,hh:mm:ss aa");
		String date=df.format(Calendar.getInstance().getTime());

		add_email.setText(date);
	    ...
	    add_name.setText(c.get_sub());
	    add_mobile.setText(c.get_note());
	    add_email.setText(c.get_date());
	    dbHandler.close();
	}
